...
{
    private static T5RL3SlipContext QcContext() => new(
    ...
    private static T5RL3SlipContext NonQcContext() => new(
    ...
    {
        var cases = T5RL3CaseBuilder.Build(QcContext());
    ...
    {
        var cases = T5RL3CaseBuilder.Build(NonQcContext());
