...
public sealed class T4FHSARL32SlipGenerator : ISlipGenerator
{
    private readonly GeneratorConfig _config;
    private readonly IRandomService _random;
    private readonly IEnumerable<ISlipBuilder<T4FHSARL32SlipContext>> _builders;
    private readonly IAnomalyService _anomalyService;
    private readonly IGenerationLogger _logger;

    public T4FHSARL32SlipGenerator(
        GeneratorConfig config,
        IRandomService random,
        IEnumerable<ISlipBuilder<T4FHSARL32SlipContext>> builders,
    ...
    private T4FHSARL32SlipContext BuildContext(int seq)
    {
        // TODO: Implement T4FHSARL32-specific context building logic
        throw new NotImplementedException("T4FHSARL32 context building not yet implemented");
    }
}
